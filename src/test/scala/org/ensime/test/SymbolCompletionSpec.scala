...
class SymbolCompletionSpec extends Spec with ShouldMatchers{
  ...
  describe("Symbol Completion") {
	...
	val syms = cc.askCompletionsAt(src.position(4,2), 0, true)
	...
	val syms = cc.askCompletionsAt(src.position(4,1), 0, true)
	...
	val syms = cc.askCompletionsAt(src.position(6,1), 0, true)
	...
	val syms1 = cc.askCompletionsAt(src.position(4,2), 0, true)
	...
	val syms = cc.askCompletionsAt(src2.position(4,2), 0, true)
