  ...
  describe("Server") {
    it("should open the test project") {
      ...
      IntgUtil.withTestProject("src/test/resources/intg/simple", "simple") { (projectBase, interactor) =>
        ...
        // typecheck
        interactor.expectRPC(20 seconds, s"""(swank:typecheck-file "$projectBase/src/main/scala/org/example/Foo.scala")""",
          """(:ok t)""")
        interactor.expectAsync(10 seconds, "(:clear-all-scala-notes)")

        // semantic highlighting
        interactor.expectRPC(20 seconds, s"""(swank:symbol-designations "$projectBase/src/main/scala/org/example/Foo.scala" -1 299 (var val varField valField functionCall operator param class trait object package))""",
          s"""(:ok (:file "$projectBase/src/main/scala/org/example/Foo.scala" :syms ((package 12 19) (package 8 11) (trait 40 43) (valField 69 71) (class 100 103) (param 125 126) (class 128 131) (param 133 134) (class 136 142) (operator 156 157) (param 154 155) (functionCall 160 166) (param 158 159) (valField 183 187) (class 193 199) (class 201 204) (valField 214 218) (class 224 227) (functionCall 232 239) (operator 250 251) (valField 256 257) (valField 252 255) (functionCall 261 268) (functionCall 273 283) (valField 269 272))))""")
        ...
        val inspectResp = interactor.sendRPCExp(20 seconds, SExp.read(s"""(swank:symbol-at-point "$projectBase/src/main/scala/org/example/Foo.scala" 128)"""))
        ...
        // uses of symbol
        interactor.expectRPC(30 seconds, s"""(swank:uses-of-symbol-at-point "$projectBase/src/main/scala/org/example/Foo.scala" 121)""",
          s"""(:ok ((:file "$projectBase/src/main/scala/org/example/Foo.scala" :offset 114 :start 110 :end 172) (:file "$projectBase/src/main/scala/org/example/Foo.scala" :offset 273 :start 269 :end 283)))"""
        )
      }
    }
  }
